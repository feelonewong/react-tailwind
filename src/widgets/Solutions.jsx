...
function Solutions () {
    return (
        <div>
            <SectionHeading title="大标题" subTitle="副标题"/>
            <div className="grid lg:grid-cols-2 mt-20 gap-20 ">
                <div>
                    ...
                    <p className="mt-4 mb-8 text-gray-500">
                        强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具
                    </p>
                    <ul className="grid gap-3">
                        {[1,2,3].map((v)=>(
                            <li key={v} className={`p-5 justify-between rounded border border-zinc-100 ${v=== 1 && 'bg-zinc-100'}`}>
                                <p className="text-lg font-bold">构建简单的生态系统构建简单的生态系统</p>
                                <div className="flex justify-between relative">
                                    <p className="text-lg leading-7 mt-1 line-clamp-2">嘻嘻哈哈的简单的生态系统构建简单的生态系统构建简单的生态系统构建建简单的生态系统构建简单的生态系统构建老顽童国荣啊过时东方航空拉屎大富科技了</p>
                                    <svg
                                        width="38"
                                        height="38"
                                        viewBox="0 0 38 38"
